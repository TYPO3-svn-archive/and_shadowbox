...
(function(){
    ...
    var options = {
         ...
         */
        loadingImage:       'typo3conf/ext/and_shadowbox/res/image/loading.gif',
         ...
         */
        flvPlayer:          'typo3conf/ext/and_shadowbox/flvplayer.swf',
         ...
         */
        overlayBgImage:     'typo3conf/ext/and_shadowbox/res/image/overlay-85.png',
    ...
    var buildBars = function(){
        ...
        var desc_i = SL.get('shadowbox_description');
        desc_i.innerHTML = '';
        if(options.displaydesc) {
          desc_i.innerHTML = (link.desc) ? '<div class="shadowbox_description_inner">' + link.desc + '</div>' : '';
        } else {
          SL.setStyle(SL.get('shadowbox_description'), 'display', 'none');
        }
        ...
        if(current_gallery.length > 1 && options.displayCounter){
            ...
            if(options.counterType == 'skip'){
                ...
                counter = (current + 1) + ' ' + options.text.of + ' ' + current_gallery.length;
            }
